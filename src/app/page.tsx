  ...
  return (
    <div className="hero bg-[#2a2a270d]">
      <div className="flex p-10 justify-center items-center">
        <div>
          <motion.div
            className="flex flex-col md:flex-row gap-5 md:gap-14"
            initial="hidden"
            animate="visible"
            variants={variants}
            custom={0.0}
          ...
          >
            Where{" "}
            <span className="bg-gradient-to-r from-[#2A2A27] to-[#E3B04A] bg-clip-text text-transparent">
              Cleanliness
            </span>{" "}
            Meets Excellence!
          </motion.h1>
          ...
          <div className="gap-4 mt-5 flex">
            <motion.button
              ...
              className="py-4 max-w-40 w-full bg-[#2A2A27] hover:shadow-xl transition-all hover:translate-y-[-5px] rounded text-white"
            >
              Send a Quote
            </motion.button>
            <motion.button
              ...
              variants={show}
              custom={1}
              onClick={() => (location.href = "#our-services")}
              className="py-4 max-w-40 w-full bg-[#f1d7ac4d] hover:shadow-xl hover:translate-y-[-5px] transition-all rounded text-black"
            >
              Learn More
            </motion.button>
          </div>
        ...
        >
          <Image
            className="aspect-square w-[30em]"
            src={image1}
            alt="Hero Image"
          />
        </motion.div>
...
function ServiceSection() {
  ...
  return (
    <div
      id="our-services"
      className="our-services mt-8 mx-8 flex items-center flex-col"
    >
        ...
        <div className="service-section mt-10 grid md:grid-cols-2 gap-10">
          {services.map((service, index) => (
            <motion.div
              ...
              exit="hidden"
              variants={variants}
              className="bg-[#2a2a270d] max-w-[30em] p-10 rounded-lg"
            >
              <ServiceCard
                key={index}
                url={service.url}
  ...
  return (
    <div className="our-services bg-[#2a2a270d] py-20 mt-10  flex items-center flex-col ">
      <h1 className="text-4xl font-bold text-center">
        Why <span className="text-[#E3B04A]">Choose</span> CleenrSpot
      </h1>
      <div
        ref={foo}
        className="service-section mt-10 mx-8 justify-center flex flex-wrap md:flex-row flex-col gap-10"
      >
      ...
      <div className="service-section mt- flex justify-center flex-col h-[30em] w-full">
        <div className="flex flex-1 justify-center items-center">
          <AnimatePresence mode="wait">
            ...
            >
              <ReviewCard
                user={reviewData[currentReview].user}
                desc={reviewData[currentReview].desc}
                rating={reviewData[currentReview].rating}
              />
            </motion.div>
          </AnimatePresence>
        </div>
  ...
  return (
    <div className="our-services flex items-center flex-col mx-8">
      <h1 className="text-4xl mt-20 font-bold text-center">
        How <span className="text-[#E3B04A]">CleenrSpot</span> Works
      </h1>
...
function ServiceCard({
  ...
  return (
    <a href={`/${url}`} className="w-full h-full">
      <Image
        className="image-placeholder aspect-square m-auto w-20"
        src={image}
        alt=""
      />
      <h1 className={`text-[#E3B04A] text-center text-2xl font-bold mt-2`}>
        {title}
      </h1>
...
function ProcessCard({
  ...
  return (
    <div
      className={`max-w-[32em] p-8 bg-[#f1d7ac33] relative rounded-xl shadow`}
    >
      <div
        className={` aspect-square border-[#f7f7f7] border-[.5em] w-20 flex justify-center items-center absolute -top-10  md:left-[-30px]  rounded-full  bg-[#2a2a27]`}
      >
  ...
  return (
    <div className={`flex flex-col items-center mt-24 p-8`}>
      ...
      <div className={`flex flex-col w-full mt-5 items-center `}>
        ...
        <div
          className={`flex bg-white flex-col md:flex-row p-10 gap-8 rounded-xl items-center max-w-[65em] justify-around mt-5 shadow`}
        >
          <Image className={`aspect-square w-36`} src={house2} alt={``} />
          <div className={`flex flex-col justify-center `}>
            <h1 className={`text-[#E3B04A] text-2xl font-bold`}>
          ...
          <div className={`flex flex-col gap-5 justify-center `}>
            <button
              onClick={() => (location.href = "#quote")}
              className={`p-2 bg-[#2A2A27] rounded  text-white hover:shadow-xl hover:translate-y-[-3px] transition-all`}
            >
              Get a Quote
            </button>
            <button
              onClick={() => (location.href = "tel:+61406780941")}
              className={`py-2 px-4 bg-[#f1d7ac4d] hover:shadow-xl hover:translate-y-[-3px] transition-all`}
            >
              Call us Now
            </button>
          </div>
...
const GetAQuote = () => {
  ...
  return (
    <div id={"quote"} className={`p-8 md:p-16 md:px-52`}>
      ...
      <div
        className={`flex md:flex-row flex-col items-center justify-center gap-8 mt-5`}
      >
        <form
          action={`#`}
          className={`flex flex-col bg-[#2a2a270d] max-w-[50em] flex-1 w-full p-10 rounded-xl gap-5 shadow items-center`}
        ...
        >
          <div className="relative w-full">
            ...
            <input
              ...
              className={`bg-${
                name ? "green" : "red"
              }-50 border text-sm rounded-lg block w-full p-2.5 ${
                errors.name &&
                "border-red-500 text-red-900 bg-red-100 placeholder-red-700"
              } ${name && (errors.name = "")}`}
              placeholder="John"
            />
            {errors.name && (
          ...
          <div className="relative w-full">
            ...
            <input
              value={suburb}
              onChange={handleChange(setSuburb)}
              type="text"
              id="suburb"
              className={`bg-${
                suburb ? "green" : "red"
          ...
          <div className="relative w-full">
            ...
            <textarea
              ...
              className={`bg-${
                details ? "green" : "red"
              }-50 border text-sm rounded-lg block w-full p-2.5 h-24 ${
                errors.details &&
                "border-red-500 text-red-900 bg-red-100 placeholder-red-700"
          ...
          <button
            className={`bg-[#2A2A27] rounded-md max-w-64 w-full p-3 text-white`}
            type={`submit`}
          >
            {buttonMessage}
          </button>

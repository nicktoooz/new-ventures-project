      ...
      <main className={`flex bg-[#dde4fb] flex-col`}>
            ...
            <div className={`flex flex-wrap  ml-8`}>
              <div className={`p-5`}>
                <div className={`w-[18em] bg-[#FFFFFF] p-10 rounded-md shadow-xl flex flex-col items-center`}>
                  ...
                  <p className={`text-center mt-2`}>Our professional cleaners are thoroughly vetted and trained to provide the highest standard of service.</p>
                </div>
              </div>
          ...
          <div className={`px-28 py-16`}>
            <div className={`flex flex-wrap gap-16  justify-center`}>
              <div className={`w-[32em] h-52 p-8 bg-[#dde4fb] relative rounded-xl shadow-xl`}>
                <div className={` flex justify-center items-center absolute top-[-32px] left-[-30px] rounded-full w-20 h-20  bg-[#5465FF]`}>
                  <h1 className={`text-4xl font-bold text-white`}>1</h1>
                </div>
                <h1 className={`mt-3 text-xl font-bold`}>Consultation</h1>
                <p className={`mt-2`}>We start with a free consultation to understand your cleaning needs and preferences. Whether it’s a one-time deep clean or regular maintenance, we tailor our services to fit your requirements.</p>
              </div>
        ...
        <div className={`flex flex-col items-center mt-24 bg-white p-16`}>
          ...
          <div className={`flex flex-col w-full p-10 mt-5 items-center `}>
            ...
            <div className={`flex bg-[#dde4fb] p-10 rounded-xl items-center w-[65em] justify-around mt-5 shadow-xl`}>
              ...
              <div className={`flex flex-col gap-5 justify-center `}>
                <button className={`p-2 bg-[#5465FF] hover:bg-white hover:text-[#5465FF] border border-[#5465FF] rounded text-white`}>Get a Quote</button>
                <button className={`py-2 px-4 bg-white hover:bg-[#5465FF] hover:text-white rounded text-[#5465FF] border border-[#5465FF]`}>Call us Now</button>
              </div>
            </div>
          </div>
        </div>

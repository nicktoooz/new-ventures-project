       ...
       <main className={`flex bg-[#dde4fb] flex-col`}>
           ...
           <div className={`flex mt-5 p-10 justify-around `}>
               <div>
                   ...
                   <h1 className={`text-4xl font-bold mt-2`}>Where <span
                   ...
                   <div className={`flex flex-wrap gap-5 items-center justify-center mt-5`}>
                       <div className={`p-8`}>
                           <div className={`w-[30em] p-10 bg-[#dde4fb] rounded-md shadow-xl`}>
                               ...
                               <p className={`mt-2`}>Our professional cleaning team is dedicated to providing top-notch
                                   cleaning services tailored to your specific need</p>
                           </div>
                       </div>
                       ...
                       <div className={`p-8`}>
                           <div className={`w-[30em] h-[16.5em] p-10 bg-[#dde4fb] rounded-md shadow-xl`}>
                               ...
                               <h1 className={`text-[#5465FF] text-xl font-bold mt-2`}>Commercial / Office Cleaning</h1>
                               <p className={`mt-2`}>Our team of expert cleaners is dedicated to delivering top-notch
                       ...
                       <div className={`p-8`}>
                           <div className={`w-[30em] p-10 bg-[#dde4fb] rounded-md shadow-xl`}>
                               ...
                               <p className={`mt-2`}>Our end of lease cleaning service is designed to meet the stringent
                       ...
                       <div className={`p-8`}>
                           <div className={`w-[30em] p-10 bg-[#dde4fb] rounded-md shadow-xl`}>
                               ...
                               <p className={`mt-2`}>Window cleaning services for a wide range of clients, including
           ...
           <div className={`flex flex-col items-center p-16`}>
               <h1 className={` text-4xl font-bold`}> Why <span className={`text-[#5465FF]`}>Choose </span>Don Denciong?
               </h1>
           ...
           <div className={`bg-white py-16 mt-14 flex flex-col items-center  `}>
               <h1 className={`text-center text-4xl font-bold`}>Our <span className={`text-[#5465FF]`}>Process</span>
               </h1>
               <div className={`px-28 py-16`}>
                   <div className={`flex flex-wrap gap-16  justify-center`}>
                       ...
                       <div className={`w-[32em] h-52 p-8 bg-[#dde4fb] relative rounded-xl  shadow-xl`}>
                           ...
                           <p className={`mt-2`}>Based on the consultation, we create a customized cleaning plan that
                               outlines the tasks, schedule, and pricing. We ensure transparency and no hidden
                               costs.</p>
                       </div>
                       ...
                       <div className={`w-[32em] h-52 p-8 bg-[#dde4fb] relative rounded-xl  shadow-xl`}>
                           ...
                           <p className={`mt-2`}>Our experienced team arrives on time, fully equipped with eco-friendly
                               cleaning products and tools. We follow the plan meticulously, ensuring every corner is
                               spotless.</p>
                       </div>
                       ...
                       <div className={`w-[32em] h-52 p-8 bg-[#dde4fb] relative rounded-xl  shadow-xl`}>
                           ...
                           <p className={`mt-2`}>We welcome your feedback and use it to improve our services. We also
                               offer follow-up services to maintain the cleanliness of your space.</p>
                       </div>
                   </div>
               </div>
           </div>
           ...
           {/*Get a Quote*/}
           <div className={`p-16`}>
               <h1 className={`text-4xl font-bold text-center`}>Get a <span className={`text-[#5465FF]`}>Quote</span>
               </h1>
               <div className={`flex items-center justify-center gap-8 mt-5 `}>
                   <div>
                       <h1 className={`font-bold text-2xl`}>Get your Free <span className={`text-[#5465FF]`}>Cleaning Quote</span>
                       </h1>

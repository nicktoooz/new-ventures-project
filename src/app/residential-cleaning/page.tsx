    ...
    <div>
      ...
      >
        <div className="hero-content z-10 text-white   max-w-[60em] px-10">
          ...
          <p>
            We understand the importance of a clean and healthy home. Our
            professional cleaning team is dedicated to providing top-notch
            cleaning services tailored to your specific needs. We offer a
            comprehensive range of cleaning services to ensure every corner of
            your home sparkles!
          </p>
...
function Body() {
  ...
  return (
    <div className="flex flex-col items-center py-10">
      <p className="text-center max-w-[50em] my-10">

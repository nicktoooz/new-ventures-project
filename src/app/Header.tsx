            ...
            <header className={`h-16 relative bg-white z-40 shadow-md flex justify-between px-5 items-center `}>
                ...
                <div className={`header-right z-50`}>
                    <div className={`md:hidden`} onClick={() => setMenu(!menuVisibility)}>
                        <span className={`bg-[#5465FF] h-1.5 w-10 rounded block transition-all duration-500`} style={{
                            rotate: `${menuVisibility ? '45deg' : '0deg'}`,
                            transform: `${menuVisibility ? 'translateY(10px) translateX(4px)' : 'translateY(0px)'}`
                        }}></span>
                        <span className={`bg-[#5465FF] h-1.5 w-10 rounded block transition-all duration-500 my-1`}

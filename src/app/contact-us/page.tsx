  ...
  return (
    <main className={`items-center p-2`}>
      ...
      <div className={`flex items-center flex-col-reverse md:flex-row p-10 md:gap-5 justify-center`}>
        <div className={`mt-10`}>
          <p className={``}>
            Ready to experience exceptional cleaning services? <br /> Reach out to us for a free quote or to schedule your first cleaning.
          </p>
          <div className={`flex flex-col gap-2 mt-10 font-bold`}>
            <section className={`flex gap-2`} onClick={() => (location.href = 'tel:+61406780941')}>
